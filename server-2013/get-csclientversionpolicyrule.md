...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413048(v=OCS.15)
ms:contentKeyID: 49311710
ms.date: 05/19/2016
...
Returns the client version policy rules configured for use in your organization. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the client version policy rule data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
