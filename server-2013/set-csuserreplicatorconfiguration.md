...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398540(v=OCS.15)
ms:contentKeyID: 49310126
ms.date: 05/19/2016
...
Modifies an existing collection of User Replicator configuration settings. The User Replicator periodically retrieves up-to-date user account information from Доменные службы Active Directory and then synchronizes the new information with the current user data stored by Lync Server. Данный командлет впервые появился в Lync Server 2010.
