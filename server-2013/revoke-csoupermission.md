...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398977(v=OCS.15)
ms:contentKeyID: 49311406
ms.date: 05/19/2016
...
Revokes the Lync Server management permissions that have been granted on an Active Directory organizational unit (OU). Данный командлет впервые появился в Lync Server 2010.
