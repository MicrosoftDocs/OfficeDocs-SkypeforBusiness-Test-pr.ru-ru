...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Hh690028(v=OCS.15)
ms:contentKeyID: 49310223
ms.date: 05/19/2016
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account for the push notification configuration settings being deleted. For example:</p>
