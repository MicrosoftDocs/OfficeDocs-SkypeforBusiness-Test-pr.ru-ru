...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204927(v=OCS.15)
ms:contentKeyID: 49309884
ms.date: 05/19/2016
...
**управления Lync Server:** To remove a collection of Persistent Chat configuration settings using the управления Lync Server, click **Persistent Chat** and then click **Persistent Chat Configuration**. Select the collection to be removed, click **Edit**, and then click **Delete**.
