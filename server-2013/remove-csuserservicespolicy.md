...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204629(v=OCS.15)
ms:contentKeyID: 49308761
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the R**emove-CsUserServicesPolicy** cmdlet are not available in the управления Lync Server.
...
<td><p>Removes the user services policy assigned to the specified Skype для бизнеса Online tenant. When removing a policy assigned to a tenant, you must also include the Identity parameter along with the parameter value &quot;global&quot;:</p>
