...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204658(v=OCS.15)
ms:contentKeyID: 49308872
ms.date: 05/19/2016
...
Creates a new centralized logging configuration region. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Centralized logging regions are intended for use with Skype для бизнеса Online.
...
**управления Lync Server:** The functions carried out by the **New-CsClsRegion** cmdlet are not available in the управления Lync Server.
