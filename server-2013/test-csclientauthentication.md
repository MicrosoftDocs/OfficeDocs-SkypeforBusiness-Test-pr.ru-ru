...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ619181(v=OCS.15)
ms:contentKeyID: 49310043
ms.date: 05/19/2016
...
Determines whether or not a user can log on to Lync Server by using a certificate downloaded from the certificate provisioning service. Данный командлет впервые появился в Lync Server 2013. It replaces the **Test-CSClientAuth** cmdlet used in Lync Server 2010.
