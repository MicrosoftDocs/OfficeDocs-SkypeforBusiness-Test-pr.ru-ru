...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398913(v=OCS.15)
ms:contentKeyID: 49311259
ms.date: 05/19/2016
...
Removes a domain from the list of domains approved for federation. Данный командлет впервые появился в Lync Server 2010.
