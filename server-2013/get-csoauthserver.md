...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205238(v=OCS.15)
ms:contentKeyID: 49311072
ms.date: 05/19/2016
...
Returns information about the Open Authorization (OAuth) servers configured for use by the organization. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Get-CsOAuthServer** cmdlet are not available in the управления Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account whose OAuth server settings are to be retrieved.</p>
<p>For example:</p>
