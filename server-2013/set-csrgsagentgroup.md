...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425955(v=OCS.15)
ms:contentKeyID: 49309656
ms.date: 05/19/2016
...
Modifies an existing Response Group agent group. An agent group is a collection of agents assigned to a Response Group queue. Agents are the users assigned to answer calls directed to a particular queue. Данный командлет впервые появился в Lync Server 2010.
