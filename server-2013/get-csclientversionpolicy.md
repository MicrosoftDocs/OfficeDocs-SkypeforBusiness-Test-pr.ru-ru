...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398957(v=OCS.15)
ms:contentKeyID: 49311339
ms.date: 05/19/2016
...
<td><p>Retrieves the client version policy data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
