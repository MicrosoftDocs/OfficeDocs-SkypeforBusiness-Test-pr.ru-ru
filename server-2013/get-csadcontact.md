...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412776(v=OCS.15)
ms:contentKeyID: 49310761
ms.date: 05/19/2016
...
The command shown in Example 1 returns a collection of all the multi-forest contacts found in Доменные службы Active Directory. Calling the **Get-CsAdContact** cmdlet without any additional parameters returns all the property values for all the Active Directory contacts.
