...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412850(v=OCS.15)
ms:contentKeyID: 49310875
ms.date: 05/19/2016
...
Modifies the property values of an existing server application. Server applications are applications that are hosted by Lync Server. Данный командлет впервые появился в Lync Server 2010.
