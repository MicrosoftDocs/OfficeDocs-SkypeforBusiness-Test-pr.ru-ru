...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205123(v=OCS.15)
ms:contentKeyID: 49310604
ms.date: 05/19/2016
...
Returns information about the Persistent Chat chat rooms configured for use in your organization. A chat room is a discussion forum that typically revolves around a specific topic. Данный командлет впервые появился в Lync Server 2013.
