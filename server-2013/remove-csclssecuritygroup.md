...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204958(v=OCS.15)
ms:contentKeyID: 49310013
ms.date: 05/19/2016
...
Removes a centralized logging configuration security group. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Remove-CsClsSecurityGroup** cmdlet are not available in the управления Lync Server.
