...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398510(v=OCS.15)
ms:contentKeyID: 49310096
ms.date: 05/19/2016
...
Modifies Lync Server properties for an existing user account. Properties can be modified only for accounts that have been enabled for use with Lync Server. Данный командлет впервые появился в Lync Server 2010.
