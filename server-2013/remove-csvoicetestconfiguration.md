...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412813(v=OCS.15)
ms:contentKeyID: 49310818
ms.date: 05/19/2016
...
Removes a voice test configuration that was used to test phone numbers against specified routes and rules. Данный командлет впервые появился в Lync Server 2010.
