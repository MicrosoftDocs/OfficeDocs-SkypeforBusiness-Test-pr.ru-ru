...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204904(v=OCS.15)
ms:contentKeyID: 49309814
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the Get-CsFIPSConfiguration cmdlet are not available in the управления Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account whose FIPS configuration settings are to be retrieved.</p>
<p>For example:</p>
