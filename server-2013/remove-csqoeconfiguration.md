...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425879(v=OCS.15)
ms:contentKeyID: 49309492
ms.date: 05/19/2016
...
Removes a collection of QoE (Quality of Experience) settings. Данный командлет впервые появился в Lync Server 2010.
