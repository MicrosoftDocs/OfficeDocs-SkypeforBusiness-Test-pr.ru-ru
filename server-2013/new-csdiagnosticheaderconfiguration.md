...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398350(v=OCS.15)
ms:contentKeyID: 49309787
ms.date: 05/19/2016
...
Creates a new diagnostic header configuration setting collection. Diagnostic header configuration settings determine whether SIP messages are accompanied by header information that can be useful in troubleshooting and error reporting. Данный командлет впервые появился в Lync Server 2010.
