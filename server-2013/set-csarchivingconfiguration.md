...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413030(v=OCS.15)
ms:contentKeyID: 49311672
ms.date: 05/19/2016
...
Modifies an existing collection of instant messaging (IM) archiving settings. Данный командлет впервые появился в Lync Server 2010.
