...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425722(v=OCS.15)
ms:contentKeyID: 49309210
ms.date: 05/19/2016
...
Removes a location from the location configuration database for Enhanced 9-1-1 (E9-1-1). Данный командлет впервые появился в Lync Server 2010.
