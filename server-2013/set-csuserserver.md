...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413026(v=OCS.15)
ms:contentKeyID: 49311668
ms.date: 05/19/2016
...
Enables you to modify an existing User Services pool. Among other things, the User Services pool provides presence information and helps to manage conferences. Данный командлет впервые появился в Lync Server 2010.
