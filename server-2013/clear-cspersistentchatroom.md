...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204976(v=OCS.15)
ms:contentKeyID: 49310065
ms.date: 05/19/2016
...
Removes all the content from a Persistent Chat chat room beginning with the oldest item in the room and continuing through the specified end date. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Clear-CsPersistentChatRoom** cmdlet are not available in the управления Lync Server.
