...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398122(v=OCS.15)
ms:contentKeyID: 49308830
ms.date: 05/19/2016
...
Undoes the forest preparation tasks carried out by the **Enable-CsAdForest** cmdlet. This cmdlet is typically used only if you are uninstalling Lync Server. Данный командлет впервые появился в Lync Server 2010.
