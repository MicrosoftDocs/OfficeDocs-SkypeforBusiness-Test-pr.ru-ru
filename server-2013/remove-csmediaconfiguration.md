...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398705(v=OCS.15)
ms:contentKeyID: 49310438
ms.date: 05/19/2016
...
Removes the specified collection of media configuration settings. Данный командлет впервые появился в Lync Server 2010.
