...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205159(v=OCS.15)
ms:contentKeyID: 49310756
ms.date: 05/19/2016
...
Uninstalls a командная консоль Lync Server 2013 mirror database. A database mirror enables you to simultaneously maintain two copies of a database, each copy residing on a different server. Данный командлет впервые появился в Lync Server 2013.
...
управления Lync Server: The functions carried out by the **Uninstall-CsMirrorDatabase** cmdlet are not available in the управления Lync Server.
