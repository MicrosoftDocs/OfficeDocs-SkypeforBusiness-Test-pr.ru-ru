...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398938(v=OCS.15)
ms:contentKeyID: 49311304
ms.date: 05/19/2016
...
Resets all the network configuration settings for a Lync Server deployment to the default values. This deletes an entire call admission control (CAC) deployment and related E9-1-1 configuration. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Запрашивает подтверждение перед выполнением команды. It is recommended that you always use this parameter with this cmdlet.</p></td>
</tr>
<tr class="odd">
