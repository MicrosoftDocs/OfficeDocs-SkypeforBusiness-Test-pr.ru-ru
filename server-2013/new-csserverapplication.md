...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398096(v=OCS.15)
ms:contentKeyID: 49308793
ms.date: 05/19/2016
...
Creates a new server application. Server applications are applications that are hosted by Lync Server. Данный командлет впервые появился в Lync Server 2010.
