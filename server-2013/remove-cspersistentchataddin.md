...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205350(v=OCS.15)
ms:contentKeyID: 49311434
ms.date: 05/19/2016
...
Removes an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** To remove a Persistent Chat add-in using the управления Lync Server, click **Persistent Chat** and then click **Add-in**. Select the add-in to be removed, click **Edit**, and then click **Delete**.
