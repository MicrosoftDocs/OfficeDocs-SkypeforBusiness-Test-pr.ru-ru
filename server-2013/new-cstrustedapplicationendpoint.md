...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398594(v=OCS.15)
ms:contentKeyID: 49310241
ms.date: 05/19/2016
...
Creates a new endpoint contact for a trusted application. Данный командлет впервые появился в Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet creates a new endpoint contact object in Доменные службы Active Directory for a specified application.
