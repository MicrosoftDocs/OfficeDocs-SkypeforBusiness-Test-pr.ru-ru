...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412775(v=OCS.15)
ms:contentKeyID: 49310760
ms.date: 05/19/2016
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account for the meeting configuration settings being deleted. For example:</p>
