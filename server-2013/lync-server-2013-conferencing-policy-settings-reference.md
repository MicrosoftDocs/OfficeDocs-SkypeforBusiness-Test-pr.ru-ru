...
<tbody>
<tr class="odd">
<td>Если этот параметр имеет значение True, а параметр <strong>Разрешить участникам управлять</strong> имеет значение False, то этот параметр имеет преимущество.</td>
</tr>
</tbody>
</table>
