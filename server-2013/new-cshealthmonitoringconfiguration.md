...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398718(v=OCS.15)
ms:contentKeyID: 49310485
ms.date: 05/19/2016
...
Creates a new collection of health monitoring configuration settings for use in your organization. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. Данный командлет впервые появился в Lync Server 2010.
