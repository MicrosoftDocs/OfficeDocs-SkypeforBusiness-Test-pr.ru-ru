...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg399052(v=OCS.15)
ms:contentKeyID: 49311541
ms.date: 05/19/2016
...
Returns information about the Lync Server replication process; this includes information on whether replication is currently up to date for your Lync Server computers. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Returns additional information about the current status of the управления, including a list of active replicas and deleted replicas, as well as the location of the Active Master and the File Transfer Agent services.</p></td>
</tr>
<tr class="even">
