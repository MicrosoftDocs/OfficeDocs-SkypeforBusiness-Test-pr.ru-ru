...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205163(v=OCS.15)
ms:contentKeyID: 49310750
ms.date: 05/19/2016
...
управления Lync Server: The functions carried out by the **New-CsPersistentChatComplianceConfiguration** cmdlet are not available in the управления Lync Server.
