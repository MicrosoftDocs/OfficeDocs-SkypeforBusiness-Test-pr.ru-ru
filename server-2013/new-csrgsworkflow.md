...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398246(v=OCS.15)
ms:contentKeyID: 49309096
ms.date: 05/19/2016
...
Creates a new Response Group workflow. Workflows determine the actions that are taken when the "Группа ответа" receives a phone call. Данный командлет впервые появился в Lync Server 2010.
...
<p>For example, suppose your operating system is running under the Faroese language. This language is supported by the Windows operating system, but not by the &quot;Группа ответа&quot;. Therefore, you must include the Language parameter and a supported language when creating a new workflow.</p>
<p>This is required because, if no language is specified, the workflow uses the operating system language. However, that language can be used in a workflow only if it is a language supported by the &quot;Группа ответа&quot;.</p>
