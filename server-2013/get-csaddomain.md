...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398453(v=OCS.15)
ms:contentKeyID: 49309991
ms.date: 05/19/2016
...
Returns information indicating whether Доменные службы Active Directory has been correctly configured to allow for the installation of Lync Server. Данный командлет впервые появился в Lync Server 2010.
