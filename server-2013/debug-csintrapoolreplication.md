...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205103(v=OCS.15)
ms:contentKeyID: 49310609
ms.date: 05/19/2016
...
Verifies the synchronous replication of a pool by comparing the data stored for a specified user on a primary Front End server with data for that same user stored on replica Front End servers. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the Debug-CsIntraPoolReplication cmdlet are not available in the управления Lync Server.
