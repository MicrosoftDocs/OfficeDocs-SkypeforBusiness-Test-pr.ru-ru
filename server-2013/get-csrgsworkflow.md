...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425766(v=OCS.15)
ms:contentKeyID: 49309276
ms.date: 05/19/2016
...
Returns information about Response Group workflows. Workflows determine the actions that are taken when the "Группа ответа" receives a phone call. Данный командлет впервые появился в Lync Server 2010.
...
Example 2 returns information about all the "Группа ответа" workflows found on the service ApplicationServer:atl-cs-001.litwareinc.com.
