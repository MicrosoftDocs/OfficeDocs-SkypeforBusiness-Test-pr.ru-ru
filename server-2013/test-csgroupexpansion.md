...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg399009(v=OCS.15)
ms:contentKeyID: 49311453
ms.date: 05/19/2016
...
Tests the ability of a user to employ group expansion. Lync Server enables users to configure an Active Directory distribution group as a contact. When you "expand" a group you will see the name and presence information for each member of the group. Данный командлет впервые появился в Lync Server 2010.
