...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205356(v=OCS.15)
ms:contentKeyID: 49311498
ms.date: 05/19/2016
...
Returns information about the reporting configuration settings in use in the organization. Reporting configuration settings are used to specify the URL used for accessing Lync Server 2013 Monitoring Reports. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Get-CsReportingConfiguration** cmdlet are not available in the управления Lync Server.
