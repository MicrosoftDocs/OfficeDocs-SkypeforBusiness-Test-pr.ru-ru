...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413064(v=OCS.15)
ms:contentKeyID: 49311731
ms.date: 05/19/2016
...
Removes the specified instant message file transfer filter configuration. (Instant message file transfer filter settings are used to block a user’s ability to transfer certain types of files within an instant message.) Данный командлет впервые появился в Lync Server 2010.
