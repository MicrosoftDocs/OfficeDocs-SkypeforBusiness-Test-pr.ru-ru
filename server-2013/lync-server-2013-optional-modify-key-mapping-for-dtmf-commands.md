...
<tbody>
<tr class="odd">
<td>Дополнительные сведения об этих командлетах и доступных параметрах DTMF см. в документации Командная консоль Lync Server или в справке командной строки Командная консоль Lync Server.</td>
</tr>
</tbody>
</table>
