...
4.  На странице **Глобально** выберите **глобальную** конфигурацию.
    ...
    <tbody>
    <tr class="odd">
    <td>Для каждого развертывания Microsoft Lync Server 2013 может быть настроена только одна сеть, поэтому в этом списке всегда будет только одна конфигурация сети. Переименовать глобальную конфигурацию нельзя.</td>
    </tr>
    </tbody>
    </table>
