...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ619177(v=OCS.15)
ms:contentKeyID: 49309614
ms.date: 05/19/2016
...
Creates a new collection of centralized logging configuration settings. Centralized logging provides a way for administrators to simultaneously enable or disable Lync Server 2013 tracing on multiple computers. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **New-CsCClsConfiguration** cmdlet are not available in the управления Lync Server.
...
<p>This parameter is intended for use with Skype для бизнеса Online.</p></td>
</tr>
<tr class="odd">
