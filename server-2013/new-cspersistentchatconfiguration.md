...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205330(v=OCS.15)
ms:contentKeyID: 49311420
ms.date: 05/19/2016
...
**управления Lync Server:** To create a new collection of Persistent Chat configuration settings using the управления Lync Server, click **Persistent Chat**, click **Persistent Chat Configuration**, click **New**, and then click either **Site configuration** or **Pool configuration**.
