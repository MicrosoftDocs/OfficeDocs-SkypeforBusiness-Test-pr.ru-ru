...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204907(v=OCS.15)
ms:contentKeyID: 49309838
ms.date: 05/19/2016
...
Assigns a per-user Persistent Chat policy to a user. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** To assign a Persistent Chat policy to a user in the управления Lync Server, double-click the appropriate user account. In the **Edit Lync Server User** dialog box, select a policy from the **Persistent Chat policy** dropdown list and then click **Commit**.
