...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398340(v=OCS.15)
ms:contentKeyID: 49309778
ms.date: 05/19/2016
...
Modifies an existing collection of User Services configuration settings. The User Services service is used to help maintain presence information and manage conferencing. Данный командлет впервые появился в Lync Server 2010.
