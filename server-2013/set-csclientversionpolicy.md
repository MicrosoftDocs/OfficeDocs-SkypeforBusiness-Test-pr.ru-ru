...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398876(v=OCS.15)
ms:contentKeyID: 49311203
ms.date: 05/19/2016
...
Modifies an existing client version policy. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be allowed to log on to your Lync Server system. Данный командлет впервые появился в Lync Server 2010.
