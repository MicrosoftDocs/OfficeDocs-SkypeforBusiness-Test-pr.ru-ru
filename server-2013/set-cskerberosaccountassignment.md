...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398232(v=OCS.15)
ms:contentKeyID: 49309058
ms.date: 05/19/2016
...
Associates a Kerberos account, which is used for IIS Internet Information Services (IIS) authentication, with a site. Данный командлет впервые появился в Lync Server 2010.
