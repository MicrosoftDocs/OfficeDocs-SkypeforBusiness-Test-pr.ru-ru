...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204721(v=OCS.15)
ms:contentKeyID: 49309106
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** To modify an existing Persistent Chat add-in using the управления Lync Server, click **Persistent Chat**, click **Add-in**, then double-click the add-in to be modified.
