...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204971(v=OCS.15)
ms:contentKeyID: 49310051
ms.date: 05/19/2016
...
Removes one or more centralized logging configuration regions. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Centralized logging regions are intended for use with Skype для бизнеса Online.
