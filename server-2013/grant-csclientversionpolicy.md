...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412903(v=OCS.15)
ms:contentKeyID: 49310988
ms.date: 05/19/2016
...
Assigns a client version policy at the global, site, service, or per-user scope. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. Данный командлет впервые появился в Lync Server 2010.
