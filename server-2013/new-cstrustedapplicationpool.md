...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425804(v=OCS.15)
ms:contentKeyID: 49309338
ms.date: 05/19/2016
...
Creates a new pool that will contain the computers that host trusted applications. Данный командлет впервые появился в Lync Server 2010.
