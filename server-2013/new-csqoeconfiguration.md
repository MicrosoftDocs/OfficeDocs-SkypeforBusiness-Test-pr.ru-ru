...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398325(v=OCS.15)
ms:contentKeyID: 49309743
ms.date: 05/19/2016
...
Creates a new collection of QoE (Quality of Experience) settings. Данный командлет впервые появился в Lync Server 2010.
...
<p>Note that even if EnableQoE is set to True, QoE data will not be collected unless a мониторинга has been deployed and associated with a Registrar pool.</p>
<p>Default: True</p></td>
</tr>
<tr class="even">
