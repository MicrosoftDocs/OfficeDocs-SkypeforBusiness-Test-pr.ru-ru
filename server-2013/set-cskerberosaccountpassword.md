...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398659(v=OCS.15)
ms:contentKeyID: 49310382
ms.date: 05/19/2016
...
Locates each server running служб in a site that has been assigned a Kerberos account, and then updates the Internet Information Services (IIS) configuration settings on each of those servers. Данный командлет впервые появился в Lync Server 2010.
