...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205337(v=OCS.15)
ms:contentKeyID: 49311467
ms.date: 05/19/2016
...
Converts exported user data to the data format used by either Microsoft Lync Server 2010 or Lync Server 2013. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Convert-CsUserData** cmdlet are not available in the управления Lync Server.
