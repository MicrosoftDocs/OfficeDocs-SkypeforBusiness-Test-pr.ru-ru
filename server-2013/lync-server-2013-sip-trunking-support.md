...
<tbody>
<tr class="odd">
<td>Подробные сведения о том, как и почему можно использовать распространенное распределение каналов SIP, см. в разделе <a href="lync-server-2013-branch-site-sip-trunking.md">Распределение каналов SIP для сайта филиала в Lync Server 2013</a> документации по планированию.</td>
</tr>
</tbody>
</table>
