...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412919(v=OCS.15)
ms:contentKeyID: 49310979
ms.date: 05/19/2016
...
Creates a new collection of Call Park service settings. Call parking is a service that allows a user to "park" an incoming phone call. Parking a call transfers it to a number in a specified range, or orbit, and immediately places the call on hold. Anyone (not just the person who originally answered the call) can resume the conversation from any telephone by entering the correct number. Данный командлет впервые появился в Lync Server 2010.
