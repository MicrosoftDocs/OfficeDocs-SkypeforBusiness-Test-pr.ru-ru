...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398574(v=OCS.15)
ms:contentKeyID: 49310195
ms.date: 05/19/2016
...
Returns information about the configuration settings for computers running the доступа in your organization (also known as Access Edge servers). Access Edge servers provide a way for users outside your internal network to communicate with users inside your internal network. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the Access Edge configuration data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
