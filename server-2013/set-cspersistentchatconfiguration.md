...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205122(v=OCS.15)
ms:contentKeyID: 49310601
ms.date: 05/19/2016
...
**управления Lync Server:** To modify an existing collection of Persistent Chat configuration settings using the управления Lync Server, click **Persistent Chat**, click **Persistent Chat Configuration**, then double-click the collection to be modified.
