...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205140(v=OCS.15)
ms:contentKeyID: 49310712
ms.date: 05/19/2016
...
**управления Lync Server:** To view Persistent Chat configuration information in the управления Lync Server, click **Persistent Chat** and then click **Persistent Chat Configuration**.
