...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ619169(v=OCS.15)
ms:contentKeyID: 49308954
ms.date: 05/19/2016
...
Flushes the centralized logging service cache. Centralized logging provides a way for administrators to simultaneously enable or disable Lync Server 2013 tracing on multiple computers. Данный командлет впервые появился в Lync Server 2013.
