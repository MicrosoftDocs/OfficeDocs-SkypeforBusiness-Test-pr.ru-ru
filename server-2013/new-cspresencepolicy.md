...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412747(v=OCS.15)
ms:contentKeyID: 49310686
ms.date: 05/19/2016
...
Creates a new presence policy at either the site scope or the per-user scope. Данный командлет впервые появился в Lync Server 2010.
