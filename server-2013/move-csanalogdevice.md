...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398816(v=OCS.15)
ms:contentKeyID: 49311130
ms.date: 05/19/2016
...
Moves one or more analog devices to a new Registrar pool. An analog device is a telephone or other device that is connected to the public switched telephone network (PSTN). Данный командлет впервые появился в Lync Server 2010.
