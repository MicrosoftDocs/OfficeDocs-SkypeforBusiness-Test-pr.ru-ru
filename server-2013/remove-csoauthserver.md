...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205408(v=OCS.15)
ms:contentKeyID: 49311751
ms.date: 05/19/2016
...
Removes an existing Open Authorization (OAuth) server. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Remove-CsOAuthServer** cmdlet are not available in the управления Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account for the OAuth server being deleted. For example:</p>
