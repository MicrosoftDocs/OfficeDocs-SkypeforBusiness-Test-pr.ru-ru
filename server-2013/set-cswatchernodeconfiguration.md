...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204620(v=OCS.15)
ms:contentKeyID: 49308737
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the **Set-CsWatcherNodeConfiguration** cmdlet are not available in the управления Lync Server.
