...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398175(v=OCS.15)
ms:contentKeyID: 49308925
ms.date: 05/19/2016
...
Creates a new bandwidth policy service configuration. Данный командлет впервые появился в Lync Server 2010.
