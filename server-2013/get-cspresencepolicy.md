...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398463(v=OCS.15)
ms:contentKeyID: 49310007
ms.date: 05/19/2016
...
Returns information about the presence policies configured for use in your organization. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the presence policy data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
