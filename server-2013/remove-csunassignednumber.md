...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398209(v=OCS.15)
ms:contentKeyID: 49309010
ms.date: 05/19/2016
...
Removes an existing range of unassigned numbers and the routing rules that apply to those numbers. Данный командлет впервые появился в Lync Server 2010.
