...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425899(v=OCS.15)
ms:contentKeyID: 49309532
ms.date: 05/19/2016
...
Creates a new device update management test device. Test devices provide a way for administrators to test firmware updates before those updates are distributed to all the devices in an organization. Данный командлет впервые появился в Lync Server 2010.
