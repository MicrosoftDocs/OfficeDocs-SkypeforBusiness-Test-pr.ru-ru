...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412929(v=OCS.15)
ms:contentKeyID: 49311037
ms.date: 05/19/2016
...
Configures an existing set of Response Group business hours. Business hour sets are used to indicate the days of the week and the times of day when Response Group agents are typically available to answer phone calls. Данный командлет впервые появился в Lync Server 2010.
