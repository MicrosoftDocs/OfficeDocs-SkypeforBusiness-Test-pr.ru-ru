...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398748(v=OCS.15)
ms:contentKeyID: 49310548
ms.date: 05/19/2016
...
Returns information about the analog devices you can manage by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network. Данный командлет впервые появился в Lync Server 2010.
