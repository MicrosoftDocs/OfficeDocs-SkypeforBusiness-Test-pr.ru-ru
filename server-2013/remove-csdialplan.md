...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398791(v=OCS.15)
ms:contentKeyID: 49310618
ms.date: 05/19/2016
...
Removes the specified dial plan. This cmdlet can also be used to remove the global dial plan. If you remove the global dial plan, however, the dial plan will not actually be removed; instead, the settings will simply be reset to their default values. Данный командлет впервые появился в Lync Server 2010.
