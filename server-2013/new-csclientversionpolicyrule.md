...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398905(v=OCS.15)
ms:contentKeyID: 49311249
ms.date: 05/19/2016
...
Creates a new client version policy rule. Client version policy rules help determine whether users can use a specific client application to log on to Lync Server. Данный командлет впервые появился в Lync Server 2010.
