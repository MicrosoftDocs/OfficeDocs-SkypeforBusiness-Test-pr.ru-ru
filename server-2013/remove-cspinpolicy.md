...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398431(v=OCS.15)
ms:contentKeyID: 49309940
ms.date: 05/19/2016
...
Removes the specified personal identification number (PIN) policy. PIN authentication and PIN policies enable users to access Lync Server by providing a PIN instead of a user name and password. Данный командлет впервые появился в Lync Server 2010.
