...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413008(v=OCS.15)
ms:contentKeyID: 49311629
ms.date: 05/19/2016
...
Returns configuration information for computers running the аудио- и видеоконференций in your organization. The configuration settings on these computers, also known as A/V Edge servers, enable internal users to share audio and video data with external users (that is, users who are not logged on to your internal network), as well as exchange files and participate in desktop sharing sessions. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the A/V Edge configuration data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
