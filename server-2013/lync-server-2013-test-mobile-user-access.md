...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dn767947(v=OCS.15)
ms:contentKeyID: 62486226
ms.date: 12/10/2016
...
For more information, see the help topic for the [Test-CsMcxConference](test-csmcxconference.md) cmdlet.
