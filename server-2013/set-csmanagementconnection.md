...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413045(v=OCS.15)
ms:contentKeyID: 49311703
ms.date: 05/19/2016
...
Modifies the management connection to the управления. Данный командлет впервые появился в Lync Server 2010.
