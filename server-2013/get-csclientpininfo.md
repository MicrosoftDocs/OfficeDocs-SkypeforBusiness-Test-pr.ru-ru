...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425947(v=OCS.15)
ms:contentKeyID: 49309634
ms.date: 05/19/2016
...
Retrieves information about the personal identification number (PIN) assigned to a user. Данный командлет впервые появился в Lync Server 2010.
