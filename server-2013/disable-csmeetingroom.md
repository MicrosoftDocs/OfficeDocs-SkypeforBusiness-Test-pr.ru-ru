...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204723(v=OCS.15)
ms:contentKeyID: 49309108
ms.date: 05/19/2016
...
Disables a Lync Server 2013 meeting room. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. When you disable a meeting room object you remove all the Lync Server-specific Active Directory attributes assigned to the user account that represents the meeting room. However, the Active Directory user account itself is not deleted. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Disable-CsMeetingRoom** cmdlet are not available in the управления Lync Server.
