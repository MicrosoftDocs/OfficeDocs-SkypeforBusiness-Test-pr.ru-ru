...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412852(v=OCS.15)
ms:contentKeyID: 49310881
ms.date: 05/19/2016
...
Verifies that a user can log on to Lync Server using a Lync Phone Edition-compatible device. Данный командлет впервые появился в Lync Server 2010.
