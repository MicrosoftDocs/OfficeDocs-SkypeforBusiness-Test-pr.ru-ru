...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425858(v=OCS.15)
ms:contentKeyID: 49309457
ms.date: 05/19/2016
...
Creates an object reference to the default certificate used by Lync Server. This object reference can then be used to configure a static route to use Transport Layer Security (TLS) as its transport protocol. Данный командлет впервые появился в Lync Server 2010.
