...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204879(v=OCS.15)
ms:contentKeyID: 49309738
ms.date: 05/19/2016
...
Returns information about the centralized logging configuration regions in use in the organization. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Centralized logging regions are intended for use with Skype для бизнеса Online.
...
**управления Lync Server:** The functions carried out by the **Get-CsClsRegion** cmdlet are not available in the управления Lync Server.
