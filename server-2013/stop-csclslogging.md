...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ619180(v=OCS.15)
ms:contentKeyID: 49309978
ms.date: 05/19/2016
...
Stops the specified scenario centralized logging service scenario. Centralized logging provides a way for administrators to simultaneously enable or disable Lync Server 2013 tracing on multiple computers. Данный командлет впервые появился в Lync Server 2013.
