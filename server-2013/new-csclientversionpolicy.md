...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398709(v=OCS.15)
ms:contentKeyID: 49310454
ms.date: 05/19/2016
...
Creates a new client version policy. Client version policies enable you to specify which versions of clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. Данный командлет впервые появился в Lync Server 2010.
