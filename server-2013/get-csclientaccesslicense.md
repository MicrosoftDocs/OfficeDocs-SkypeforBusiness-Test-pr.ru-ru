...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204853(v=OCS.15)
ms:contentKeyID: 49309596
ms.date: 05/19/2016
...
Returns information about client license usage in your organization. Данный командлет впервые появился в Lync Server 2013.
...
<tbody>
<tr class="odd">
<td>For more information, and for ways to work around these issues, see the <a href="lync-server-2013-release-notes.md">Примечания к выпуску для Lync Server 2013</a>.</td>
</tr>
</tbody>
</table>
...
**управления Lync Server:** The functions carried out by the **Get-CsClientAccessLicense** cmdlet are not available in the управления Lync Server.
