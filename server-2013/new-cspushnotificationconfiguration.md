...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Hh690027(v=OCS.15)
ms:contentKeyID: 49310462
ms.date: 05/19/2016
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account for which the new push notification configuration settings are being created. For example:</p>
