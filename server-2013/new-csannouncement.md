...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398522(v=OCS.15)
ms:contentKeyID: 49310097
ms.date: 05/19/2016
...
Creates a new Lync Server announcement. Announcements are played when users dial a valid but unassigned phone number. An announcement can be a message (such as "This number is temporarily out of service") or a busy signal. Данный командлет впервые появился в Lync Server 2010.
