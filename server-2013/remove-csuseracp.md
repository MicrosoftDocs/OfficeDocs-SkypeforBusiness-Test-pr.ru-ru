...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398982(v=OCS.15)
ms:contentKeyID: 49311394
ms.date: 05/19/2016
...
Removes one or more audio conferencing providers assigned to a user or group of users. Данный командлет впервые появился в Lync Server 2010.
