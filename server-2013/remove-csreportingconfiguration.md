...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204711(v=OCS.15)
ms:contentKeyID: 49309070
ms.date: 05/19/2016
...
Removes an existing collection of reporting configuration settings. Reporting configuration settings are used to specify the URL for installations of Lync Server 2013 Monitoring Reports. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Remove-CsReportingConfiguration** cmdlet are not available in the управления Lync Server.
