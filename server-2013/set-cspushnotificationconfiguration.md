...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Hh690013(v=OCS.15)
ms:contentKeyID: 49309495
ms.date: 05/19/2016
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account for the push notification settings being modified. For example:</p>
