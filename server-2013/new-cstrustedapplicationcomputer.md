...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398405(v=OCS.15)
ms:contentKeyID: 49309899
ms.date: 05/19/2016
...
Adds a computer that hosts trusted applications to an existing pool. Данный командлет впервые появился в Lync Server 2010.
