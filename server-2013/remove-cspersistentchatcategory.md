...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204660(v=OCS.15)
ms:contentKeyID: 49308883
ms.date: 05/19/2016
...
**управления Lync Server:** To remove a Persistent Chat category using the управления Lync Server, click **Persistent Chat** and then click **Category**. Select the category to be removed, click **Edit** and then click **Delete**.
