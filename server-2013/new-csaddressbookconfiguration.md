...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398395(v=OCS.15)
ms:contentKeyID: 49309868
ms.date: 05/19/2016
...
Creates a new collection of Address Book configuration settings. Данный командлет впервые появился в Lync Server 2010.
