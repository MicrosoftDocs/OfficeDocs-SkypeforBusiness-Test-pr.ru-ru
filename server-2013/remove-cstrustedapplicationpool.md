...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398750(v=OCS.15)
ms:contentKeyID: 49310532
ms.date: 05/19/2016
...
Removes a pool that contains the computers that host trusted applications. Данный командлет впервые появился в Lync Server 2010.
