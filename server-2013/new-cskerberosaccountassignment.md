...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398074(v=OCS.15)
ms:contentKeyID: 49308756
ms.date: 05/19/2016
...
Assigns a Kerberos account, which is used for Internet Information Services (IIS) authentication, to a site. Данный командлет впервые появился в Lync Server 2010.
