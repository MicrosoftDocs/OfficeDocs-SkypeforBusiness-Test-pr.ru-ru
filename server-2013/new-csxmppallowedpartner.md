...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204631(v=OCS.15)
ms:contentKeyID: 49308769
ms.date: 05/19/2016
...
**управления Lync Server:** To create a new XMPP allowed partner using управления Lync Server, click External User Access, click XMPP Federated Partners, and then click New.
