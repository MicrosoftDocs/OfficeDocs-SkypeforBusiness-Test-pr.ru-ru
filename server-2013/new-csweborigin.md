...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ950236(v=OCS.15)
ms:contentKeyID: 52058167
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the **New-CsWebOrigin** cmdlet are not available in the управления Lync Server.
