...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398916(v=OCS.15)
ms:contentKeyID: 49311268
ms.date: 05/19/2016
...
When you install Lync Server your users are only allowed to exchange instant messages and presence information among themselves: by default, they can only communicate with people who have SIP accounts in your Доменные службы Active Directory. In addition, users are not allowed to access Lync Server over the Internet; instead, they must be logged on to your internal network before they will be able to log on to Lync Server.
