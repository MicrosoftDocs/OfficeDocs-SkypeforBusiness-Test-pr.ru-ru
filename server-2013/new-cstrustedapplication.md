...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398259(v=OCS.15)
ms:contentKeyID: 49309118
ms.date: 05/19/2016
...
Adds a trusted application to a pool. Данный командлет впервые появился в Lync Server 2010.
