...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425835(v=OCS.15)
ms:contentKeyID: 49309404
ms.date: 05/19/2016
...
Deletes any rejected device update files that are no longer associated with a device. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Unique identifier of the service hosting the device update files. For example, this syntax clears device update files from the служб service for the pool atl-cs-001.litwareinc.com: -Identity &quot;service:WebServer:atl-cs-001.litwareinc.com&quot;.</p></td>
</tr>
<tr class="even">
