...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425948(v=OCS.15)
ms:contentKeyID: 49309637
ms.date: 05/19/2016
...
Returns information about the server applications in use in your organization. Server applications are applications that are hosted by Lync Server. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the server application data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
