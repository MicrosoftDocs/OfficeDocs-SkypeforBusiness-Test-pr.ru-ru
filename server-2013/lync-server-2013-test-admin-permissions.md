...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dn767945(v=OCS.15)
ms:contentKeyID: 62486224
ms.date: 05/19/2016
...
For more information on OU permissions, see the article [Заблокировано наследование разрешений для компьютеров, пользователей и контейнеров inetOrgPerson в Lync Server 2013](lync-server-2013-permissions-inheritance-is-disabled-on-computers-users-or-inetorgperson-containers.md).
