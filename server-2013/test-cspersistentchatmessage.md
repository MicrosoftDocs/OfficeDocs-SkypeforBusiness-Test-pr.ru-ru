...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204656(v=OCS.15)
ms:contentKeyID: 49308867
ms.date: 05/19/2016
...
Verifies whether or not a pair of users can exchange messages using the Persistent Chat service (formerly known as the Group Chat service). Данный командлет впервые появился в Lync Server 2013.
...
управления Lync Server: The functions carried out by the **Test-CsPersistentChatMessage** cmdlet are not available in the управления Lync Server.
