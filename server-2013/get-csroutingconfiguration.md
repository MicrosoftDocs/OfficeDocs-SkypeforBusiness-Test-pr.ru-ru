...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425851(v=OCS.15)
ms:contentKeyID: 49309445
ms.date: 05/19/2016
...
Retrieves the routing configuration object, which contains a list of all voice routes defined within a Lync Server deployment. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the routing configuration from the local replica of the управления, rather than the управления itself.</p></td>
</tr>
</tbody>
</table>
