...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412967(v=OCS.15)
ms:contentKeyID: 49311085
ms.date: 05/19/2016
...
<td><p>Indicates the maximum amount of bandwidth (in megabytes) set aside for the совместного доступа к приложениям в ходе конференций. MaxBandwidthPerAppSharingServiceMb can be set to any integer value between 50 and 100000, inclusive. The default value is 375 megabytes.</p></td>
</tr>
<tr class="even">
