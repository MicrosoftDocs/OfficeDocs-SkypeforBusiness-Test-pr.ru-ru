...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398643(v=OCS.15)
ms:contentKeyID: 49310331
ms.date: 05/19/2016
...
Resets the routing configuration to its default settings. Данный командлет впервые появился в Lync Server 2010.
