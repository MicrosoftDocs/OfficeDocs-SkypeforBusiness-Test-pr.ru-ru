...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398428(v=OCS.15)
ms:contentKeyID: 49309931
ms.date: 05/19/2016
...
Verifies that the required permissions needed to install Lync Server or one of its components have been configured on the specified Active Directory container. Данный командлет впервые появился в Lync Server 2010.
