...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Hh689989(v=OCS.15)
ms:contentKeyID: 49308775
ms.date: 05/19/2016
...
Verifies that authenticated users can use Lync Web App to join a Lync Server conference. Данный командлет впервые появился в Lync Server 2010.
