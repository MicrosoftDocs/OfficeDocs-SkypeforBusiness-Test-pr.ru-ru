...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398490(v=OCS.15)
ms:contentKeyID: 49310053
ms.date: 05/19/2016
...
Note, too that you cannot federate with a hosting provider if your сервер are configured to use default routing rather than Domain Name System (DNS) server routing.
