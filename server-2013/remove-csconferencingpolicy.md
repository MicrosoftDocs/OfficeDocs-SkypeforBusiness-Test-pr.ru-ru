...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398728(v=OCS.15)
ms:contentKeyID: 49310501
ms.date: 05/19/2016
...
Removes the specified conferencing policy. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Данный командлет впервые появился в Lync Server 2010.
