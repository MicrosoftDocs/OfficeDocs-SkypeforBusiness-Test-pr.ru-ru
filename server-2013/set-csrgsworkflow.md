...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425845(v=OCS.15)
ms:contentKeyID: 49309424
ms.date: 05/19/2016
...
Modifies an existing Response Group workflow. Workflows determine the actions that are taken when the "Группа ответа" receives a phone call. Данный командлет впервые появился в Lync Server 2010.
