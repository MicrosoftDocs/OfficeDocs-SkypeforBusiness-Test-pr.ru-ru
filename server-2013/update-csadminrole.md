...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204851(v=OCS.15)
ms:contentKeyID: 49309594
ms.date: 05/19/2016
...
Updates the role-based access control (RBAC) definitions stored in the Central Management database without affecting any other database tables. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Update-CsAdminRole** cmdlet are not available in the управления Lync Server.
