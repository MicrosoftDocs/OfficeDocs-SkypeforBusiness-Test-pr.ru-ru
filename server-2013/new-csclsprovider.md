...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ619187(v=OCS.15)
ms:contentKeyID: 49310638
ms.date: 05/19/2016
...
Creates a new centralized logging trace provider. Trace providers are application components that generate trace messages or trace events useful in troubleshooting problems with Lync Server. Данный командлет впервые появился в Lync Server 2013.
...
управления Lync Server: The functions carried out by the **New-CsClsProvider** cmdlet are not available in the управления Lync Server.
