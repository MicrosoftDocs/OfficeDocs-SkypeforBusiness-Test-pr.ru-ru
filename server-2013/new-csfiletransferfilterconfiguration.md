...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425897(v=OCS.15)
ms:contentKeyID: 49309529
ms.date: 05/19/2016
...
Creates a new file transfer filter configuration. File transfer filter configurations are used to block a user’s ability to transfer certain types of files (for example, files with a .vbs or .ps1 file extension) using a Lync Server client. Данный командлет впервые появился в Lync Server 2010.
