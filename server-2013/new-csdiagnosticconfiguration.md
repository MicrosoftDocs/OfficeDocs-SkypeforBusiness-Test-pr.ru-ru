...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398733(v=OCS.15)
ms:contentKeyID: 49310503
ms.date: 05/19/2016
...
Creates new diagnostic configuration settings. Diagnostic configuration settings are used to determine whether traffic to or from a given domain or Uniform Resource Identifier (URI) is recorded in your Lync Server log files. Данный командлет впервые появился в Lync Server 2010.
