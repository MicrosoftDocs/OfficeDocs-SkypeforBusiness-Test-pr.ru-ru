---
title: 'Lync Server 2013: сводка по сертификатам — масштабируемая консолидированная пограничная топология с аппаратными балансировщиками нагрузки'
TOCTitle: Сводка по сертификатам — масштабируемая консолидированная пограничная топология с аппаратными балансировщиками нагрузки
ms:assetid: 894a9f3e-7cba-4915-8fdf-e52f2f25126f
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398692(v=OCS.15)
ms:contentKeyID: 49310445
ms.date: 12/17/2016
...
## Сертификаты, необходимые для масштабируемого консолидированного пограничного сервера с аппаратными средствами балансировки нагрузки
...
<tr class="even">
<td><p>Отдельный консолидированный сервер (внутренний пограничный сервер)</p></td>
<td><p>lsedge.contoso.net</p></td>
<td><p>SAN не требуется</p></td>
<td><p>Сертификат может быть выдан общедоступным или частным центром сертификации и должен содержать EKU сервера. Сертификат назначается интерфейсу внутреннего сервера сервер.</p></td>
</tr>
</tbody>
</table>
