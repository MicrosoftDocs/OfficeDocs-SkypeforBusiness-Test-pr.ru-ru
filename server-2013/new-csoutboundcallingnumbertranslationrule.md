...
**управления Lync Server:** To create a new outbound calling number translation rule using the управления Lync Server, click Voice Routing then click Trunk Configuration, and then double-click the appropriate item in the Name column. In the Edit Trunk Configuration dialog box scroll down to the section labeled Calling number translation rules and then click New.
