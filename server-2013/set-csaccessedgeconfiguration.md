...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413017(v=OCS.15)
ms:contentKeyID: 49311639
ms.date: 05/19/2016
...
Modifies the property values of an existing collection of Access Edge configuration settings for computers running the доступа. The доступа running on these computers (also known as Edge servers) provides a way for users outside your internal network to communicate with users inside that internal network. Данный командлет впервые появился в Lync Server 2010.
