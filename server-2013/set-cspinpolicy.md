...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412997(v=OCS.15)
ms:contentKeyID: 49311613
ms.date: 05/19/2016
...
Modifies one or more existing client personal identification number (PIN) policies. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Данный командлет впервые появился в Lync Server 2010.
