...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398470(v=OCS.15)
ms:contentKeyID: 49310002
ms.date: 05/19/2016
...
Returns server licensing information for a computer running Lync Server. Данный командлет впервые появился в Lync Server 2010.
...
That no license key is required for the components installed on the local computer. (Licensing is required only for computers functioning as a переднего плана, a Директор, or an сервер.)
