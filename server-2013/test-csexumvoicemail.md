...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205058(v=OCS.15)
ms:contentKeyID: 49310408
ms.date: 05/19/2016
...
Verifies that a user can connect to Exchange Unified Messaging and leave a voice mail message for another user. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the Test-CsExUMVoiceMail cmdlet are not available in the управления Lync Server.
