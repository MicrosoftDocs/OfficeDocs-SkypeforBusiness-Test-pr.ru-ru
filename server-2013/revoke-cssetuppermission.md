...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425834(v=OCS.15)
ms:contentKeyID: 49309403
ms.date: 05/19/2016
...
Revokes the Lync Server setup rights that have been granted on an Active Directory organizational unit (OU). Данный командлет впервые появился в Lync Server 2010.
