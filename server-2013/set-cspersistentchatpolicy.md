...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205192(v=OCS.15)
ms:contentKeyID: 49310941
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat policy. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** To modify an existing Persistent Chat policy using the управления Lync Server, click **Persistent Chat**, click **Persistent Chat Policy**, then double-click the policy to be modified.
