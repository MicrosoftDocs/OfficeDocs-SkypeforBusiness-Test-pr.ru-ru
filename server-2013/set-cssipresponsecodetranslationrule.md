...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425895(v=OCS.15)
ms:contentKeyID: 49309512
ms.date: 05/19/2016
...
Modifies an existing SIP response code translation rule. These rules enable administrators to map SIP response codes with values between 400 and 699 to the values used by Lync Server. Данный командлет впервые появился в Lync Server 2010.
