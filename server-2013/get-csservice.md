...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413038(v=OCS.15)
ms:contentKeyID: 49311690
ms.date: 05/19/2016
...
Returns information about the services and server roles being used in your Lync Server infrastructure. A service is an instance of a role that has been deployed in a Lync Server pool. For example, you might have a pool of computers all running the Monitoring service. Данный командлет впервые появился в Lync Server 2010.
...
Example 2 returns information only about the приложения. You can return information for other services/server roles simply by using the appropriate parameter. For example, this command returns information about the file store:
...
The capabilities found in Lync Server are typically expressed as services or as server roles. For example, you can configure Lync Server to automatically save a transcript of every instant messaging session that takes place in your organization. In order to do this, you must install the архивации server role. Services and server roles can be configured at the same time you install Lync Server itself, or they can be configured after the software is up and running.
...
<td><p>Returns information about the Application databases used in your organization. Application databases are used by the приложения.</p></td>
</tr>
<tr class="even">
<td><p><em>ApplicationServer</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the приложения. The приложения provides a way to run applications created by using the Microsoft Unified Communications Managed API (UCMA).</p></td>
</tr>
<tr class="odd">
...
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the управления used in your organization. The управления is used to send configuration data to computers running Lync Server services.</p></td>
</tr>
<tr class="odd">
<td><p><em>CentralManagementDatabase</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the управления used in your organization. The управления maintains configuration information for Lync Server.</p></td>
</tr>
<tr class="even">
<td><p><em>ConferencingServer</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the аудио- и видеоконференций used in your organization. The аудио- и видеоконференций is used to conduct meetings and conferences.</p></td>
</tr>
<tr class="odd">
...
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the управления used in your organization. The управления is commonly collocated with the Front End Servers and is responsible for accessing information in the управления.</p></td>
</tr>
<tr class="even">
...
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the данных пользователей used in your organization. User databases store data needed by the User Server service.</p></td>
</tr>
<tr class="odd">
<td><p><em>UserServer</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the обслуживания пользователей service used in your organization. The обслуживания пользователей service provides such things as user replication, in-band provisioning, presence publication and notification, and contact card exchange.</p></td>
</tr>
<tr class="even">
...
<td><p>Optional</p></td>
<td><p>System.Management.Automation.SwitchParameter</p></td>
<td><p>Returns information about the служб service used in your organization. The служб service host web-based applications such as the Address Book service.</p></td>
</tr>
</tbody>
</table>
