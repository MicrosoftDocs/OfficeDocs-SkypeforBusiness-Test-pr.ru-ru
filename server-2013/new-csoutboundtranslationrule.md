...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412803(v=OCS.15)
ms:contentKeyID: 49310802
ms.date: 05/19/2016
...
Creates a new outbound translation rule. An outbound translation rule converts phone numbers to the local dialing format for interaction with private branch exchange (PBX) systems. Данный командлет впервые появился в Lync Server 2010.
