...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413042(v=OCS.15)
ms:contentKeyID: 49311702
ms.date: 05/19/2016
...
Enables you to modify management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. Данный командлет впервые появился в Lync Server 2010.
