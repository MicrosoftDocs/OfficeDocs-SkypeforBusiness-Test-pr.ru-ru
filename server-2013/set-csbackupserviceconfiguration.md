...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205006(v=OCS.15)
ms:contentKeyID: 49310156
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the **Set-CsBackupServiceConfiguration** cmdlet are not available in the управления Lync Server.
