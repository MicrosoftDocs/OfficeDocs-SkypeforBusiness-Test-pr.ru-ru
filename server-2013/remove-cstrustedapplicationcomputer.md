...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398838(v=OCS.15)
ms:contentKeyID: 49311174
ms.date: 05/19/2016
...
Removes a trusted application computer. Данный командлет впервые появился в Lync Server 2010.
