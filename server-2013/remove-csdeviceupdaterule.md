...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425930(v=OCS.15)
ms:contentKeyID: 49309588
ms.date: 05/19/2016
...
Removes a device update rule configured for use in your organization. Device update rules are used to associate firmware updates with devices that run Lync Phone Edition. Данный командлет впервые появился в Lync Server 2010.
