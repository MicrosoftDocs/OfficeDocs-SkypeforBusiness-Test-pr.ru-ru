...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398937(v=OCS.15)
ms:contentKeyID: 49311303
ms.date: 05/19/2016
...
Returns information about the Lync Server announcements configured for use in your organization. Announcements are played when users dial a valid but unassigned phone number. An announcement can be a message (such as "This number is temporarily out of service") or a busy signal. Данный командлет впервые появился в Lync Server 2010.
...
<p>- Enter the Identity of the приложения for the announcements you want to retrieve. This will retrieve all announcements configured with the given service Identity. For example, ApplicationServer:Redmond.litwareinc.com.</p>
...
<td><p>Retrieves the announcement information from the local replica of the управления, rather than the управления itself.</p></td>
</tr>
</tbody>
</table>
