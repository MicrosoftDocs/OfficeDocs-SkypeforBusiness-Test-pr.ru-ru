...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205358(v=OCS.15)
ms:contentKeyID: 49311460
ms.date: 05/19/2016
...
Uses previously-exported user information to update Lync Server user data. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Update-CsUserData** cmdlet are not available in the управления Lync Server.
