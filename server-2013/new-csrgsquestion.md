...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398186(v=OCS.15)
ms:contentKeyID: 49308953
ms.date: 05/19/2016
...
Creates a new Response Group question. The "Группа ответа" uses questions to provide callers with choices, and then takes action based on those choices. Данный командлет впервые появился в Lync Server 2010.
