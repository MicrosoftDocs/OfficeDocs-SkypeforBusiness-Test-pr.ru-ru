...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205061(v=OCS.15)
ms:contentKeyID: 49310427
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the **Get-CsClsSearchTerm** cmdlet are not available in the управления Lync Server.
