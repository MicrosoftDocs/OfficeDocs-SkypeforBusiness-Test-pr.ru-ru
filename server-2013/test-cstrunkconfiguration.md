...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398137(v=OCS.15)
ms:contentKeyID: 49308853
ms.date: 05/19/2016
...
Validates a trunk configuration against a phone number. Данный командлет впервые появился в Lync Server 2010.
