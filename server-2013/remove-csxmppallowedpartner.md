...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205055(v=OCS.15)
ms:contentKeyID: 49310415
ms.date: 05/19/2016
...
**управления Lync Server:** To remove an XMPP allowed partner using the управления Lync Server, click External User Access and then click XMPP Federated Partners. Select the partner to be removed, click Edit, and then click Delete.
