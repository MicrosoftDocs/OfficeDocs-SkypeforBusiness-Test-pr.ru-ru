...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425792(v=OCS.15)
ms:contentKeyID: 49309314
ms.date: 05/19/2016
...
Creates a new collection of dual-tone multifrequency (DTMF) signaling settings used for dial-in conferencing. DTMF enables users who dial in to a conference to control conference settings (such as muting and unmuting themselves or locking and unlocking the conference) by using the keypad on their telephone. Данный командлет впервые появился в Lync Server 2010.
