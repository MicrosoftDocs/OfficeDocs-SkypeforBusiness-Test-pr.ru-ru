...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398837(v=OCS.15)
ms:contentKeyID: 49311146
ms.date: 05/19/2016
...
Removes a trusted application endpoint. Данный командлет впервые появился в Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet removes an existing endpoint contact object from Доменные службы Active Directory.
