...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398629(v=OCS.15)
ms:contentKeyID: 49310291
ms.date: 05/19/2016
...
Creates a new SipProxy.TLS object, which can then be used to configure a static route to use Transport Layer Security (TLS) as its transport protocol. Данный командлет впервые появился в Lync Server 2010.
