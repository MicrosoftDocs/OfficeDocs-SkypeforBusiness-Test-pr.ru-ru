...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ619189(v=OCS.15)
ms:contentKeyID: 49310729
ms.date: 05/19/2016
...
Provides a command-line option for searching the centralized logging service log files. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Search-CsClsLogging** cmdlet are not available in the управления Lync Server.
