...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398101(v=OCS.15)
ms:contentKeyID: 49308804
ms.date: 05/19/2016
...
Returns information about one or more voice policies configured for your organization. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the voice policy from the local replica of the управления, rather than the управления itself.</p></td>
</tr>
<tr class="even">
<td><p><em>Tenant</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Guid</p></td>
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account whose voice policy is to be retrieved. For example:</p>
