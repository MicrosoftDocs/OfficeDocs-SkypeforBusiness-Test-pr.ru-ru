---
title: Указатель командлетов Lync Server 2013
TOCTitle: Указатель командлетов Lync Server 2013
ms:assetid: cd37aba7-3d27-4db9-b69f-3a6da1fb4b4a
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398867(v=OCS.15)
ms:contentKeyID: 49311211
ms.date: 12/10/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Указатель командлетов Lync Server 2013

 

_**Дата изменения раздела:** 2016-12-08_

Microsoft Lync Server 2013 поставляется более чем с 700 командлетами, которые позволяют администраторам управлять Lync Server 2013 из командной строки. Командлеты Lync Server обычно используются с Командная консоль Lync Server. Один из способов применения Командная консоль Lync Server — войти на компьютер с ролью сервера или службой Lync Server, нажать кнопку **Пуск**, выбрать пункт **Все программы**, щелкнуть элемент **Microsoft Lync Server 2013**, а затем выбрать команду **Командная консоль Lync Server**. После открытия командной консоли можно будет получить справку по командлету непосредственно из командной строки, введя следующую или аналогичную команду:
...
Чтобы получить полный список доступных командлетов для управления Lync Server, введите в командной строке Командная консоль Lync Server следующую команду:

    Get-Command * -Module Lync -CommandType cmdlet

Дополнительные сведения об использовании Командная консоль Lync Server см. в блоге Lync Server Windows PowerShell по адресу [http://go.microsoft.com/fwlink/?linkid=203150\&clcid=0x419](http://go.microsoft.com/fwlink/?linkid=203150%26clcid=0x419).

## Командлеты Lync Server 2013

Далее представлен список командлетов, которые поставляются с Lync Server 2013:
