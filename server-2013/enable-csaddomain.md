...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412764(v=OCS.15)
ms:contentKeyID: 49310727
ms.date: 05/19/2016
...
Modifies the security settings on the universal groups created during forest preparation. These modifications provide the permissions needed to host and manage users enabled for Lync Server within the domain. Данный командлет впервые появился в Lync Server 2010.
