...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425761(v=OCS.15)
ms:contentKeyID: 49309263
ms.date: 05/19/2016
...
<td><p>Indicates the valid log file extensions that can be used with the обновления устройств. This list can be modified; however, there is no reason to modify the list unless you have a device running Lync Server that creates log files that use a different file extension.</p>
