...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398335(v=OCS.15)
ms:contentKeyID: 49309754
ms.date: 05/19/2016
...
Creates a new collection of proxy configuration settings. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>When set to True, the proxy server functions as if all client connections are external connections that pass through the сервер running the доступа. The default value is False.</p></td>
</tr>
<tr class="odd">
