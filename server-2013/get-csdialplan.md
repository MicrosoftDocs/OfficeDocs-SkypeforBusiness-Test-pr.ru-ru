...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg413043(v=OCS.15)
ms:contentKeyID: 49311700
ms.date: 05/19/2016
...
Returns information about the dial plans used in your organization. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the dial plan information from the local replica of the управления, rather than the управления itself.</p></td>
</tr>
</tbody>
</table>
