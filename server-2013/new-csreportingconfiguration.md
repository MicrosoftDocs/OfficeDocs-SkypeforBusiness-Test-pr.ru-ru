...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204787(v=OCS.15)
ms:contentKeyID: 49309325
ms.date: 05/19/2016
...
Creates a new collection of reporting configuration settings at the service scope. Reporting configuration settings are used to specify the URL used to access Lync Server 2013 Monitoring Reports. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **New-CsReportingConfiguration** cmdlet are not available in the управления Lync Server.
