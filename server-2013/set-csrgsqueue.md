...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412947(v=OCS.15)
ms:contentKeyID: 49311051
ms.date: 05/19/2016
...
Modifies an existing Response Group queue. With the "Группа ответа", phone calls are put in a queue and callers are placed on hold until a Response Group agent is available to answer that call. Данный командлет впервые появился в Lync Server 2010.
