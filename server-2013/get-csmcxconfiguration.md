...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Hh690031(v=OCS.15)
ms:contentKeyID: 49310685
ms.date: 05/19/2016
...
<td><p>Retrieves the Mobility Service configuration data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
