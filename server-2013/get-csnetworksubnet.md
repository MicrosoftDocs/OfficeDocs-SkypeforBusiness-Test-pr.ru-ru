...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg412825(v=OCS.15)
ms:contentKeyID: 49310839
ms.date: 05/19/2016
...
Retrieves information about one or more network subnets. Данный командлет впервые появился в Lync Server 2010.
...
<td><p>Retrieves the network subnet information from the local replica of the управления, rather than the управления itself.</p></td>
</tr>
</tbody>
</table>
