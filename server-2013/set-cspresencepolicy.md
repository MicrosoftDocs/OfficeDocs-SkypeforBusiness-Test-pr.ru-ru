...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg425782(v=OCS.15)
ms:contentKeyID: 49309301
ms.date: 05/19/2016
...
Modifies an existing presence policy. Данный командлет впервые появился в Lync Server 2010.
