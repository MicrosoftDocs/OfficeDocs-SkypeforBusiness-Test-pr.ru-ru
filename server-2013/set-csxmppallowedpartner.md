...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204686(v=OCS.15)
ms:contentKeyID: 49309002
ms.date: 05/19/2016
...
**управления Lync Server:** To edit the property values for an existing XMPP allowed partner using the управления Lync Server, click External User Access, click XMPP Federated Partners, and then double-click the partner to be modified.
