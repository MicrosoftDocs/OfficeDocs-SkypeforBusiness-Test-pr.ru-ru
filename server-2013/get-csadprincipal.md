...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205326(v=OCS.15)
ms:contentKeyID: 49311398
ms.date: 05/19/2016
...
Returns information about Active Directory principals. These principals include Active Directory objects such as users, groups, contacts, containers, and organizational units. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the Get-CsAdPrincipal cmdlet are not available in the управления Lync Server.
