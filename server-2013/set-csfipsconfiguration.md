...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205084(v=OCS.15)
ms:contentKeyID: 49310519
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the **Set-CsFIPSConfiguration** cmdlet are not available in the управления Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype для бизнеса Online tenant account for which the FIPS configuration settings are being modified. For example:</p>
