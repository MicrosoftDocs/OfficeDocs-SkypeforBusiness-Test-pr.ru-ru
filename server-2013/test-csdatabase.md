...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204839(v=OCS.15)
ms:contentKeyID: 49309570
ms.date: 05/19/2016
...
Tests the configuration of the Lync Server 2013 databases. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Test-CsDatabase** cmdlet are not available in the управления Lync Server.
