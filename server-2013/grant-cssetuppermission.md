...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398569(v=OCS.15)
ms:contentKeyID: 49310202
ms.date: 05/19/2016
...
Grants Lync Server setup permissions on an Active Directory organizational unit (OU). Данный командлет впервые появился в Lync Server 2010.
