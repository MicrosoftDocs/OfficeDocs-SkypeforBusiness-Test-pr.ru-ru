...
<tbody>
<tr class="odd">
<td>Сведения, представленные в данном разделе, относятся к накопительным обновлениям для Lync Server 2013: февраль 2013 г.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td>При внесении изменений в связь зеркального отображения базы данных с таблицами следует перезапустить переднего плана в пуле.</td>
</tr>
</tbody>
</table>
