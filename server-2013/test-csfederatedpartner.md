...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398281(v=OCS.15)
ms:contentKeyID: 49309159
ms.date: 05/19/2016
...
Verifies the ability to connect to a federated domain. Данный командлет впервые появился в Lync Server 2010.
