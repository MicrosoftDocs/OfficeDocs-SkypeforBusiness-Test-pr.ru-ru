...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398877(v=OCS.15)
ms:contentKeyID: 49311206
ms.date: 05/19/2016
...
Removes an existing bandwidth policy service configuration. Данный командлет впервые появился в Lync Server 2010.
