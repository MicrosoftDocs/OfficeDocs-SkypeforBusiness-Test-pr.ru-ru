...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204949(v=OCS.15)
ms:contentKeyID: 49309944
ms.date: 05/19/2016
...
**управления Lync Server:** The functions carried out by the **Set-CsPersistentChatComplianceConfiguration** cmdlet are not available in the управления Lync Server.
