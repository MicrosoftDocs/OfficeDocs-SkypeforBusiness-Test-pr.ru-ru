...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398215(v=OCS.15)
ms:contentKeyID: 49309024
ms.date: 05/19/2016
...
Returns information about the device update rules configured for use in your organization. Device update rules are used to associate firmware updates with devices that run Lync Server. Данный командлет впервые появился в Lync Server 2010.
...
Device update rules can be imported (and applied to) the служб service. The **Get-CsDeviceUpdateRule** cmdlet enables you to return information about the device update rules that have been imported for use in your organization.
...
<td><p>Retrieves the device update rule data from the local replica of the управления rather than from the управления itself.</p></td>
</tr>
</tbody>
</table>
