...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ204740(v=OCS.15)
ms:contentKeyID: 49309171
ms.date: 05/19/2016
...
Verifies that the Lync Server Storage Service is working on a переднего плана. This is done by creating a test email message in the specified Exchange mailbox and then optionally deleting that message at the end of the text. **Test-CsExStorageConnectivity** also verifies that Exchange archiving is working as expected. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the **Test-CsExStorageConnectivity** cmdlet are not available in the управления Lync Server.
