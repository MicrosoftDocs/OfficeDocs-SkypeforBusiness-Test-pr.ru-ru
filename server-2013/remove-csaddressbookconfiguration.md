...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398934(v=OCS.15)
ms:contentKeyID: 49311299
ms.date: 05/19/2016
...
Removes the specified collection of Address Book configuration settings. Данный командлет впервые появился в Lync Server 2010.
...
In addition, Address Book servers periodically generate index files that are downloaded to computers running Lync Server. When a user searches for contacts, he or she either search through these index files or search the Address Book index files stored in the управления.
