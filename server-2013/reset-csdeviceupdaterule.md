...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg398181(v=OCS.15)
ms:contentKeyID: 49308936
ms.date: 05/19/2016
...
Rejects a device update rule that has been imported to the system. Данный командлет впервые появился в Lync Server 2010.
