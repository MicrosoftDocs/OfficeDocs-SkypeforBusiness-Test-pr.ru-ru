...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Gg399025(v=OCS.15)
ms:contentKeyID: 49311486
ms.date: 05/19/2016
...
Retrieves the settings for a trusted application. Данный командлет впервые появился в Lync Server 2010.
