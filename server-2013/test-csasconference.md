...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ205227(v=OCS.15)
ms:contentKeyID: 49311017
ms.date: 05/19/2016
...
Tests the ability of a pair of users to take part in an application sharing conference. Данный командлет впервые появился в Lync Server 2013.
...
**управления Lync Server:** The functions carried out by the Test-CsASConference cmdlet are not available in the управления Lync Server.
