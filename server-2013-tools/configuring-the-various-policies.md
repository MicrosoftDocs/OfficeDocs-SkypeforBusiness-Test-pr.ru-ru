...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ945610(v=OCS.15)
ms:contentKeyID: 52058578
ms.date: 08/05/2014
...
See the example script ArchivingPolicy.ps1. You need to use this script only if an Archiving Server is deployed in your topology. For details, see the Lync Server 2013 documentation and cmdlet Help for [Командлеты архивирования и мониторинга](https://technet.microsoft.com/ru-ru/library/gg415629\(v=ocs.15\)).

## Configuring the Conferencing Policy

See the example script MeetingPolicy.ps1. For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты веб-конференций](https://technet.microsoft.com/ru-ru/library/gg415675\(v=ocs.15\)).

## Configuring the Contacts Policy

See the example ContactsPolicy.ps1. For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты обмена мгновенными сообщениями и сведениями о присутствии](https://technet.microsoft.com/ru-ru/library/gg398611\(v=ocs.15\)).

## Configuring the Federation Policy

See the example FederationPolicy.ps1. For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты пограничного сервера](https://technet.microsoft.com/ru-ru/library/gg415635\(v=ocs.15\)) and [Командлеты федерации и внешнего доступа](https://technet.microsoft.com/ru-ru/library/gg415651\(v=ocs.15\)).

## Configuring the Call Admission Control Policy

See the example BandwidthPolicy.ps1. For details, see the Lync Server 2013 documentation [Обзор контроля допуска звонков в Lync Server 2013](https://technet.microsoft.com/ru-ru/library/gg398529\(v=ocs.15\)) and the cmdlet Help for [Командлеты контроля допуска звонков](https://technet.microsoft.com/ru-ru/library/gg415676\(v=ocs.15\)).
...
For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты корпоративной голосовой связи](https://technet.microsoft.com/ru-ru/library/gg415658\(v=ocs.15\)).
...
For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты веб-конференций](https://technet.microsoft.com/ru-ru/library/gg415675\(v=ocs.15\)) and [Командлеты конференц-связи с телефонным подключением](https://technet.microsoft.com/ru-ru/library/gg415630\(v=ocs.15\)).

## Configuring Lync Server Call Park Service

Call Park is disabled by default. See the example CallParkConfiguration.ps1. For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты приложения парковки вызовов](https://technet.microsoft.com/ru-ru/library/gg415639\(v=ocs.15\)).
...
1.  Set up a voice route for emergency calls. See the RoutingRules.ps1 script under the comment "Route E911 to PSTN" for an example of setting up this voice route.
    ...
    <thead>
    <tr class="header">
    <th><img src="images/JJ945610.Caution(OCS.15).gif" title="Caution" alt="Caution" />Внимание!</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
...
You should create all your users before running the following scripts. Follow the instructions in [Create Users and Contacts](create-users-and-contacts.md) to create users. For details, see the Lync Server 2013 cmdlet documentation for the [Get-CsUser](https://technet.microsoft.com/ru-ru/library/gg398125\(v=ocs.15\)), [Set-CsUser](https://technet.microsoft.com/ru-ru/library/gg398510\(v=ocs.15\)), and [Disable-CsUser](https://technet.microsoft.com/ru-ru/library/gg398747\(v=ocs.15\)) cmdlets.

## Configuring Response Group application

See the example ResponseGroupConfiguration.ps1. For details, see the Lync Server 2013 documentation and the cmdlet Help for [Командлеты приложения группы ответа](https://technet.microsoft.com/ru-ru/library/gg415654\(v=ocs.15\)).To review the Response Group application configuration, see `https://<poolfqdn>/RgsConfig/`, as shown in the following figure.
